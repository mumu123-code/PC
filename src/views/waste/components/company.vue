    ...
    <div class="companyCon">
        ...
        <el-card>
            ...
            <div class="info-list" v-if="showDetail">
                ...
                <el-row class="list">
                    <el-col :span="4" class="info-title">全国固体废物管理信息系统密码：</el-col>
                    <el-col :span="18" class="info-detail">
                        {{ companyInfo.wastePassword }}
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="4" class="info-title">企业联系人姓名：</el-col>
                    <el-col :span="18" class="info-detail">
                        {{ companyInfo.managerName }}
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="4" class="info-title">企业联系人电话：</el-col>
                    <el-col :span="18" class="info-detail">
                        {{ companyInfo.phone }}
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="4" class="info-title">固废管理联系人姓名：</el-col>
                    <el-col :span="18" class="info-detail">
                        {{ companyInfo.wasteLink }}
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="4" class="info-title">固废管理联系人电话：</el-col>
                    <el-col :span="18" class="info-detail">
                        {{ companyInfo.wastePhone }}
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="4" class="info-title">企业地址：</el-col>
                    <el-col :span="18" class="info-detail">
                        {{ companyInfo.address }}
                    </el-col>
                </el-row>
