...
import {
  ...
  Submenu, Select, Option, Table, TableColumn, Pagination,radio,DatePicker,Row,Col,RadioGroup
} from "element-ui";
...
Vue.use(Button).use(Form).use(FormItem).use(Input).use(Container).use(Aside).use(Main).use(Header)
  ...
  .use(TableColumn).use(Pagination).use(radio ).use(DatePicker).use(Row).use(Col).use(RadioGroup);
